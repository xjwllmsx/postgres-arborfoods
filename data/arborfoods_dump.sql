...
--
-- Name: customer_orders; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: detailed_orders; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.detailed_orders AS
 SELECT o.order_id,
    o.order_date,
    p.product_name,
    p.product_id,
...
CREATE VIEW public.employee_orders AS
